var canvas = document.getElementById('particleLayer'),
  can_w = parseInt(canvas.getAttribute('width')),
  can_h = parseInt(canvas.getAttribute('height')),
  ctx = canvas.getContext('2d') 

var devicePixelRatio = window.devicePixelRatio || 1 
var dpi_x = document.body.offsetWidth * devicePixelRatio 
var dpi_y = document.body.offsetHeight * devicePixelRatio 
var width = screen.width / dpi_x 
var height = screen.height / dpi_y 
var BALL_NUM = Math.round(width*height*100)
console.log(BALL_NUM)
console.log(width*height)
var ball = {
    x: 0, y: 0, vx: 0, vy: 0, r: 0, alpha: 1, phase: 0
  },
  ball_color = { r: 230, g: 235, b: 242 },
  R = 3,
  balls = [],
  alpha_f = 0.03,
  alpha_phase = 0,
