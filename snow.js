...
var snowStorm = (function(window, document) {
  ...
  this.snowColor = 'var(--clear)'; // Don't eat (or use?) yellow snow.
  this.snowCharacter = '&bull;';   // &bull; = bullet, &middot; is square on some systems etc.
  this.snowStick = true;           // Whether or not snow should "stick" at the bottom. When off, will never collect.
  this.targetElement = 'title';    // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
  ...
  this.vMaxY = 0.5;               // Maximum Y velocity range for snow
  this.zIndex = 998;              // CSS stacking order applied to each snowflake
